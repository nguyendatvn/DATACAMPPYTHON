...
#
# Suppose, for example, that you've calculated the return of your investment
# and want to summarize the results in a string.
# Assuming the floats savings and result are defined, you can try something like this:
#
